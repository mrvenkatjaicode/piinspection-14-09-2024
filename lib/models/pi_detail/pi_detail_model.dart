...
//
//     final piDetailResponse = piDetailResponseFromJson(jsonString);

import 'dart:convert';

PiDetailResponse piDetailResponseFromJson(String str) => PiDetailResponse.fromJson(json.decode(str));

String piDetailResponseToJson(PiDetailResponse data) => json.encode(data.toJson());
